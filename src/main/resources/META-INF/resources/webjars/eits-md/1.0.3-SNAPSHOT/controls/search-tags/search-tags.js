(function() {
    ...
    /**
     * Teclas de atalho para a cria��o das tags {enter, space, comma} e o {backspace} para remover a tag criada
    ...
    /**
     * Valores padr�es de inicializa��o
            ...
            return {
                ...
                post: function postLink( scope, element, attributes, controller ) {
                    ...
                    function TagList(){
                        ...
                        //Carrega a configura��o padr�o caso o atributo n�o conter valor adicionado
                        options = function() {
                        ...
                        //Verificamos se o valor do campo � valido
                        tagIsValid = function( ) {
                            var tag = getTagText();
                        ...
                        changeTag = function () {
                            ...
                            //Retorna um array de tags para uma fun��o criada no escopo da controller na interface
                        ...
                        //Removemos a ultima tag (Fun��o utilizada pelo backspace)
                        ...
                        //Devemos verificar se o texto adicionado j� existe em alguma das tags j� criadas
                        ...
                        //Fun��o respons�vel por redimencionar o campo quando o texto for adicionado
                    ...
                    //Respons�vel por limpar todas as tags e texto adicionado no campo
                    ...
                    //Eventos do campo para a inser��o do texto e cria��o da tag
                    scope.eventHandlers = {
                        input: {
