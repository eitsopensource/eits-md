(function () {
     ...
     * @description
     */
    angular.module('eits.controls.currency', [])
        .directive('currencyInput', CurrencyDirective);

    /**
     * @ngdoc directive
     * @name currencyInput
     * @module eits.controls.currency
     *
     * @restrict A
     *
     * @description The `<currency-input>` is a attribute directive that formats the value of the input into a currency format.
     *
     * @usage `<input type="text" currency-input ng-model="value">`
     */
    function CurrencyDirective() {
        return {
            ...
            link: function (scope, element, attrs, ngModelController) {
                ...
                /**
                 * Formata o inputValue como valor monetário
                 */
                function formatCurrency(inputValue) {
                    ...
                    if (typeof  inputValue == 'number') {
                        inputVal = new String(inputValue.toFixed(scope.decimal))
                    } else {
                        inputVal = inputValue;
                    }
